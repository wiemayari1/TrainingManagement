...
import {
    ...
    AutoGraph, CompareArrows, DonutLarge, ShowChart,
...
export default function Stats() {
    ...
    const tabs = [
        ...
        { label:'Formateurs',                icon: EmojiEvents },
    ];
        ...
        <Box sx={{ p:{ xs:2, md:3 }, bgcolor:'#F8FAFC', minHeight:'100vh' }}>
            ...
            <motion.div initial={{ opacity:0, y:-20 }} animate={{ opacity:1, y:0 }} transition={{ duration:.5 }}>
                <Box sx={{
                    ...
                    <Box sx={{ position:'absolute', top:-40, right:-40, width:200, height:200, borderRadius:'50%', bgcolor:'rgba(99,102,241,.15)' }} />
                    <Box sx={{ position:'absolute', bottom:-20, left:'30%', width:120, height:120, borderRadius:'50%', bgcolor:'rgba(139,92,246,.1)' }} />
                    <Box sx={{ position:'relative', zIndex:1, display:'flex', justifyContent:'space-between', alignItems:'flex-start', flexWrap:'wrap', gap:2 }}>
                        <Box>
                            ...
                            <Typography sx={{ color:'#A5B4FC', fontSize:'0.875rem' }}>
                                Tableau de bord analytique multi-annuel · 2022–2026
                            </Typography>
                        </Box>
                        <Box sx={{ display:'flex', gap:1.5, alignItems:'center', flexWrap:'wrap' }}>
                            <FormControl size="small" sx={{ minWidth:110 }}>
                                <Select
                                    ...
                                    sx={{
                                        bgcolor:'rgba(255,255,255,.1)', color:'#fff', borderRadius:2,
                                        ...
                                        <Card sx={{ border:'1px solid #E2E8F0', borderRadius:2.5, boxShadow:'none', textAlign:'center' }}>
                                            <CardContent sx={{ p:1.5 }}>
                                                ...
                                                <Box sx={{ height:3, bgcolor:'#F1F5F9', borderRadius:2, mt:1, overflow:'hidden' }}>
                                                    <Box sx={{
                                                        height:'100%', borderRadius:2, bgcolor:PALETTE.indigo.main,
                        ...
                        <Grid container spacing={2.5}>
                            ...
                            <Grid item xs={12}>
                                <Card sx={{ border:'1px solid #E2E8F0', borderRadius:3, boxShadow:'none' }}>
                                    <CardContent sx={{ p:3 }}>
                                        <Typography sx={{ fontWeight:700, fontSize:'1rem', color:'#0F172A', mb:.5 }}>
                                            Notes par domaine — comparaison {activeYears.join(' vs ')}
                                        </Typography>
                                        <Typography sx={{ fontSize:'0.75rem', color:'#94A3B8', mb:2 }}>
                                ...
                                <Card sx={{ border:'1px solid #E2E8F0', borderRadius:3, boxShadow:'none' }}>
                                    <CardContent sx={{ p:3 }}>
                                        <Box sx={{ display:'flex', alignItems:'center', gap:1.5, mb:2.5 }}>
                                            <EmojiEvents sx={{ color:PALETTE.amber.main, fontSize:24 }} />
                                            <Box>
                                                <Typography sx={{ fontWeight:700, fontSize:'1rem', color:'#0F172A' }}>
                                                    Classement des Formateurs — {primaryYear}
                                                </Typography>
                                                <Typography sx={{ fontSize:'0.72rem', color:'#94A3B8' }}>Classé par note moyenne</Typography>
                                            </Box>
                                        </Box>
                                        <TableContainer>
                                            <Table size="small">
                                                ...
                                                <TableBody>
                                                    {(stats.topFormateurs||[]).map((f, i) => {
                                                        ...
                                                        const sat = f.noteMoyenne ? (f.noteMoyenne/20*5).toFixed(1) : '—';
                                                        const medals = ['🥇','🥈','🥉'];
                                                        return (
                                                            <TableRow key={i} sx={{ '&:hover': { bgcolor:'#FAFBFF' } }}>
                                                                ...
                                                                <TableCell>
                                                                    <Box sx={{ display:'flex', alignItems:'center', gap:1.2 }}>
                                                                        <Avatar sx={{ width:32, height:32, fontSize:'0.75rem', fontWeight:700, bgcolor: f.type==='INTERNE'?'#DCFCE7':'#EDE9FE', color: f.type==='INTERNE'?'#15803D':'#7C3AED' }}>
                                                                            {(f.nom||'').charAt(0)}
                                                                        </Avatar>
                                                                ...
                                                                <TableCell>
                                                                    <Chip label={f.type} size="small" sx={{ height:18, fontSize:'0.65rem', fontWeight:700, bgcolor: f.type==='INTERNE'?'#DCFCE7':'#EDE9FE', color: f.type==='INTERNE'?'#15803D':'#7C3AED' }} />
                                                                </TableCell>
                                                                <TableCell align="center">
                                                                    <Chip label={f.nbFormations} size="small" variant="outlined" sx={{ fontWeight:700, fontSize:'0.78rem', color:PALETTE.indigo.main, borderColor:`${PALETTE.indigo.main}60` }} />
                                                                </TableCell>
                                                                <TableCell align="center">
                                                                ...
                                                                <TableCell align="center">
                                                                    {notePct && (
                                                                        <Box sx={{ display:'flex', flexDirection:'column', alignItems:'center', gap:.4 }}>
                                                                            <Chip label={`${notePct}%`} size="small" sx={{ height:20, fontSize:'0.72rem', fontWeight:800, bgcolor: notePct>=80?'#DCFCE7':notePct>=70?'#FEF3C7':'#FEE2E2', color: notePct>=80?'#14532D':notePct>=70?'#78350F':'#7F1D1D' }} />
                                                                            <Box sx={{ width:60, height:4, bgcolor:'#F1F5F9', borderRadius:2, overflow:'hidden' }}>
                                                                                <Box sx={{ height:'100%', width:`${notePct}%`, bgcolor: notePct>=80?PALETTE.emerald.main:notePct>=70?PALETTE.amber.main:PALETTE.rose.main, borderRadius:2 }} />
                                                                            </Box>
                                                                        </Box>
                                                                    )}
                                                                </TableCell>
                                                                <TableCell align="center">
                                                                    <Box sx={{ display:'flex', alignItems:'center', gap:.4 }}>
                                                                        ...
                                                                        <Typography sx={{ fontSize:'0.85rem', fontWeight:700, color:'#0F172A' }}>{sat}</Typography>
                                                                    </Box>
                                                                </TableCell>
                                                            </TableRow>
                                                        );
                                    ...
                                    <Grid item xs={12}>
                                        <Card sx={{ border:'1px solid #E2E8F0', borderRadius:3, boxShadow:'none' }}>
                                            <CardContent sx={{ p:3, textAlign:'center' }}>
                                                <Typography sx={{ fontWeight:700, fontSize:'1rem', color:'#0F172A', mb:2 }}>Internes vs Externes</Typography>
                                                <Box sx={{ display:'flex', gap:1.5, justifyContent:'center', mb:2 }}>
                                                    {[{label:'Internes',value:stats.formateursInternes||0,color:PALETTE.emerald.main,bg:PALETTE.emerald.light},{label:'Externes',value:stats.formateursExternes||0,color:'#8B5CF6',bg:'#F5F3FF'}].map((item,i)=>(
                                                ...
                                                <ResponsiveContainer width="100%" height={160}>
                                                    <PieChart>
                                                        <Pie data={[{name:'Internes',value:stats.formateursInternes||0},{name:'Externes',value:stats.formateursExternes||0}]} cx="50%" cy="50%" innerRadius={45} outerRadius={70} paddingAngle={3} dataKey="value">
                                    ...
                                    <Grid item xs={12}>
                                        <Card sx={{ border:'1px solid #E2E8F0', borderRadius:3, boxShadow:'none' }}>
                                            <CardContent sx={{ p:3 }}>
                                                ...
                                                <ResponsiveContainer width="100%" height={200}>
                                                    <RadarChart data={(stats.notesMoyennesParDomaine||[]).map(d => ({ domaine: d.domaine.substring(0,6), note: Math.round(d.note*10)/10 }))}>
